            ...
            <div className="flex-grow text-gray-800">
                <header className="flex items-center h-20 px-6 sm:px-10 bg-white">
                    ...
                    <div className="relative w-full max-w-md sm:-ml-2">
                        ...
                        <input onChange={() => console.log("buscando...")} type="text" role="search" placeholder="Search..." className="py-2 pl-10 pr-4 w-full border-4 border-transparent placeholder-gray-400 focus:bg-gray-50 rounded-lg" />
                    </div>
